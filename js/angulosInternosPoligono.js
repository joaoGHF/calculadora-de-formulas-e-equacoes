var btnSomaAngulosInternosPoligono = document.getElementById("soma-angulos-internos-poligono");

btnSomaAngulosInternosPoligono.addEventListener("click", function(){
    somaAngulosInternosPoligono();
})

function somaAngulosInternosPoligono(){  
    ...
    var label1 = criarLabel("input1", "label-input1", "Insira o valor da soma dos angulos internos (Si):");
